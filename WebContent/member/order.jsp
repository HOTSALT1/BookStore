...
<div id="agreement_radio1" class="agreement_radio txt-center">
	<label for="radio-agree1"><input type="radio" name="radio-agree1" id="radio-agree1" value="Y" /><strong>동의</strong></label>&nbsp;
	<label for="radio-agree2"><input type="radio" name="radio-agree1" id="radio-agree2" value="N" checked/>비동의</label>
</div>
...
<div id="agreement_radio2" class="agreement_radio txt-center">
	<label for="radio-agree3"><input type="radio" name="radio-agree2" id="radio-agree3" value="Y" /><strong>동의</strong></label>&nbsp;
	<label for="radio-agree4"><input type="radio" name="radio-agree2" id="radio-agree4" value="N" checked/>비동의</label>
</div>
...
$('#btn-confirm').click(function() {
	...
	/* 초기화 */
	$('#radio-agree1+strong').css('color','');
	$('#radio-agree3+strong').css('color','');
	let chk = true;
	
	/* 정보 수집 및 이용 동의 확인 */
	if($('#radio-agree2').is(":checked")){
		alert("개인정보 수집 및 이용에 동의하셔야 구매가 가능합니다.");
		$('#radio-agree1').focus();
		fnMove('agreementWrap1');
		$('#radio-agree1+strong').css('color','red');
		chk = false;
	}else if($('#radio-agree4').is(":checked")){
		alert("개인정보 처리 및 위탁에 동의하셔야 구매가 가능합니다.");
		$('#radio-agree3').focus();
		fnMove('agreementWrap2');
		$('#radio-agree3+strong').css('color','red');
		chk = false;
